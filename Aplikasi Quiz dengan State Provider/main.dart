...
class Quiz with ChangeNotifier {
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'questionText': 'Apa fungsi utama dari widget Scaffold dalam Flutter?',
      'answers': [
        {'text': 'Menambahkan animasi pada aplikas', 'score': 0},
        {
          'text':
              'Menyediakan struktur dasar tata letak untuk sebuah halaman aplikasi',
          'score': 1
        },
        {'text': 'Mengelola data dari backend ke UI', 'score': 0},
        {'text': 'Membuat aplikasi menjadi lebih responsif', 'score': 0},
      ],
    },
